...
//Exceptions
var InvalidBusStopError = new TypeError("Bus stop does not exist");
...
module.exports = {
     ...
     * @example getBusPositions({routeId: 'D2', lat: 38.896584, lon: -76.958446, radius: 5}).then(...)
     * @returns {Promise|undefined} A promise that if successful, returns an object containing bus position
     *      information. If rejected, contains as error object. Not returned if a callback is given.
    */
    ...
    */
    ...
    getBusPredictions(stopId, callback){
        if(typeof stopId === 'undefined'){
            return Promise.reject('You must specify a bus stop ID.');
        }
