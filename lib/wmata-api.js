        ...
        var reqPromise = function(resolve, reject){
            ...
            .get({
                    ...
                    if(err) reject(err);
                        ...
                        reject(new WmataApiError('WMATA Api access denied. Make sure your API key is valid.', resp.statusCode));
                    }
                    
                    else{
                        reject(new WmataApiError('Unexpected status code.', resp.statusCode));
                    }
                });
        }
